...
public class PuertaMetalicaUblablaEntity extends BaseEntity {

    private static final EntityDataAccessor<Boolean> IS_OPEN = SynchedEntityData.defineId(
            PuertaMetalicaUblablaEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Direction> DATA_FACING =
            SynchedEntityData.defineId(PuertaMetalicaUblablaEntity.class, EntityDataSerializers.DIRECTION);
    ...
    public PuertaMetalicaUblablaEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
